...
<section>
  ...
  <div class="before-after-gallery" style="display: flex; gap: 20px; flex-wrap: wrap; margin: 40px 0;">
    <figure style="flex: 1; min-width: 250px; margin: 0;">
      <a href="javascript:void(0)" class="zoom-trigger">
        <img src="/assets/img/Workpics/sketch_ui_workpics.webp" alt="Hand-drawn paper sketch of WorkPics UI zoning" data-caption="Initial Paper Zoning">
      </a>
    ...
    <div style="flex: 1; min-width: 250px;">
      ...
      <ul>
        ...
        <li><strong>Oversized Controls:</strong> Buttons are large and spaced out to prevent miss-clicks with gloves.</li>
      </ul>
    </div>
  </div>
  ...
  <section>
    <div class="color-palette-container">
      <h4 class="color-palette-title">Color Palette</h4>
      <div class="color-palette-grid">
        <div class="color-item">
          <div class="color-block" style="background-color: #F5F5F5; border: 1px solid #555;"></div>
        ...
        <div class="color-item">
          <div class="color-block" style="background-color: #08CB00;"></div>
          <p class="color-hex">#08CB00</p>
          <p class="color-desc">Success</p>
        </div>
        <div class="color-item">
          <div class="color-block" style="background-color: #FF6600;"></div>
          <p class="color-hex">#FF6600</p>
          <p class="color-desc">Alert/Action</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="bento-gallery" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; margin: 40px 0;">
    <div class="bento-item" style="border: none; background: transparent; box-shadow: none;">
      <figure style="margin:0">
        <a href="javascript:void(0)" class="zoom-trigger">
          <img src="/assets/img/Workpics/workpics1.webp" alt="WorkPics logo proposal A — camera shutter concept" data-caption="Concept A: The Shutter">
        </a>
    ...
    <div class="bento-item" style="border: none; background: transparent; box-shadow: none;">
      <figure style="margin:0">
        <a href="javascript:void(0)" class="zoom-trigger">
          <img src="/assets/img/Workpics/workpics2.webp" alt="WorkPics logo proposal B — cloud sync concept" data-caption="Concept B: The Cloud Sync">
        </a>
    ...
    <div class="bento-item" style="border: none; background: transparent; box-shadow: none;">
      <figure style="margin:0">
        ...
        <figcaption style="text-align:center; color:var(--text-muted); margin-top:10px; font-weight:600;">✓ Client's Choice (Final)</figcaption>
      </figure>
    </div>
  </div>
  ...
  <div class="bento-gallery" style="grid-template-columns: 1fr 1fr; gap: 40px; margin: 40px 0;">
    <div class="bento-item" style="border: none; background: transparent; box-shadow: none;">
      <figure style="margin:0">
        <a href="javascript:void(0)" class="zoom-trigger">
          <img src="/assets/img/Workpics/5.webp" alt="Logo construction breakdown showing W + P + checkmark geometry" data-caption="Deconstruction: W + P + Check">
        </a>
        <figcaption style="text-align:center; color:var(--text-muted); margin-top:10px;">Geometry / Composition</figcaption>
      </figure>
    </div>
    <div class="bento-item" style="border: none; background: transparent; box-shadow: none;">
      <figure style="margin:0">
        <a href="javascript:void(0)" class="zoom-trigger">
          <img src="/assets/img/Workpics/19.webp" alt="Logo construction showing negative space usage" data-caption="Deconstruction: Negative Space">
        </a>
        <figcaption style="text-align:center; color:var(--text-muted); margin-top:10px;">Geometry / Composition</figcaption>
      </figure>
    </div>
...
<section class="bento-gallery">
  <div class="bento-item" style="grid-column: span 2;">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/workpicks_ui_mockups.webp" alt="WorkPics camera interface with oversized controls" data-caption="Camera Interface: Clean & Big Buttons">
    </a>
  </div>
  <div class="bento-item">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/14.webp" alt="WorkPics logo on dark background" data-caption="Logo Variant on Dark Background">
    </a>
  </div>
  <div class="bento-item">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/27.webp" alt="WorkPics logo on light background" data-caption="Logo Variant on Light Background">
    </a>
  </div>
  <div class="bento-item" style="grid-column: span 2;">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/13.webp" alt="WorkPics dashboard overview screen" data-caption="Main Dashboard Overview">
    </a>
  </div>
  <div class="bento-item">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/25.webp" alt="WorkPics settings and profile flow" data-caption="Settings & Profile Flow">
    </a>
  </div>
  <div class="bento-item">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/workpics_bag.webp" alt="WorkPics branded tote bag mockup" data-caption="Brand application: Tote Bag">
    </a>
  </div>
  <div class="bento-item">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/workpics_cap2.webp" alt="WorkPics branding on orange safety helmet" data-caption="High-Vis Helmet Branding">
    </a>
  </div>
  <div class="bento-item">
    <a href="javascript:void(0)" class="zoom-trigger">
      <img src="/assets/img/Workpics/workpics_cap_black.webp" alt="WorkPics branding on black manager helmet" data-caption="Manager Helmet Branding">
    </a>
  </div>
</section>
